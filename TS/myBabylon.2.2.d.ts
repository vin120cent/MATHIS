...
//declare module BABYLON {
//    /**
//     * Node is the basic class for all scene objects (Mamesh, Light Camera).
//     */
//    class Node {
//        parent: Node;
//        name: string;
...
//        /**
//         * Get a the last added node (Mamesh, Camera, Light) found of a given ID
//         * @param {string} id - the id to search for
...
//        connectAudioNodes(inputAudioNode: any, outputAudioNode: any): void;
//        dispose(): void;
//    }
//}
//
...
//        setAudioBuffer(audioBuffer: any): void;
...
//         * @param {Mamesh} source - An optional Mamesh from which geometry is shared, cloned.
...
//         * @param {Array<Mamesh>} meshes - The vertices source.  They should all be of the same material.  Entries can empty
//         * @param {boolean} disposeSource - When true (default), dispose of the vertices from the source meshes
//         * @param {boolean} allow32BitsIndices - When the sum of the vertices > 64k, this must be set to true.
//         * @param {Mamesh} meshSubclass - When set, vertices inserted into this Mamesh.  Meshes can then be merged into a Mamesh sub-class.
//         */
