...
module mathis {
    ...
    export class Geometry {
        ...
        private aZero=XYZ.newZero()
        angleBetweenTwoVectors( v1:XYZ, v2:XYZ):number{
        ...
        closerOf(candidat1:XYZ,canditat2:XYZ,reference:XYZ,result:XYZ):void{
        ...
        public  LookAtLH(eye: XYZ, target: XYZ, up: XYZ, result: MM): void {
            // Z axis
        ...
        public  OrthoOffCenterLH(left: number, right, bottom: number, top: number, znear: number, zfar: number, result: MM): void {
        ...
        public  PerspectiveFovLH(fov: number, aspect: number, znear: number, zfar: number, result: MM): void {
        ...
        public  hermiteSpline(p1: XYZ, t1: XYZ, p2: XYZ, t2: XYZ, nbPoints: number  ,result:XYZ[]):void  {
            clearArray(result)
            var step = 1 / nbPoints;
        ...
        public  quadraticBezier(v0: XYZ, v1: XYZ, v2: XYZ, nbPoints: number,result:XYZ[]):void  {
            clearArray(result)
        ...
        public  cubicBezier(v0: XYZ, v1: XYZ, v2: XYZ, v3: XYZ, nbPoints: number,result:XYZ[]): void {
            clearArray(result)
