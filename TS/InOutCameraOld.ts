...
//
//        constructor(private camera:InOutCamera,private showAVirtualObsSphere,radiusOfObsShere,radiusOfExteriorShere) {
...
//
//            /**default value*/
//            basic.copyXyzFromFloat(0, 1, 0, this.camera.upVector)
//            basic.copyXyzFromFloat(0, 0, 1, this.camera.frontDir)
//
//
...
//                    basic.copyXYZ(this.camera.upVector, this._additionnalVec)
...
//                    geo.cross(this.camera.frontDir, this.camera.upVector, this._additionnalVec)
//                    geo.add(this._additionnalVec, this._axeForKeyRotation, this._axeForKeyRotation)
//                } else if (this.keysRight.indexOf(keyCode) !== -1) {
//                    basic.copyXYZ(this.camera.upVector, this._additionnalVec)
//                    geo.add(this._additionnalVec, this._axeForKeyRotation, this._axeForKeyRotation)
//                } else if (this.keysDown.indexOf(keyCode) !== -1) {
//                    geo.cross(this.camera.upVector, this.camera.frontDir, this._additionnalVec)
//                    geo.add(this._additionnalVec, this._axeForKeyRotation, this._axeForKeyRotation)
//                }
//            }
//
...
//                geo.scale(this.camera.frontDir, 1 - alpha, this._correction)
//
//                geo.normalize(this.camera.position, this._camPosCopy)
...
//            var l = geo.norme(this.camera.position)
...
//            geo.orthonormalizeKeepingFirstDirection(vector, this.camera.upVector, this.camera.frontDir, this.camera.upVector)
//        }
//
//
...
//            geo.multiplicationMatrixVector(this._matrixRotationAroundCam, this.camera.frontDir, this.camera.frontDir)
//            geo.multiplicationMatrixVector(this._matrixRotationAroundCam, this.camera.upVector, this.camera.upVector)
//        }
//
...
//            geo.multiplicationMatrixVector(this._matrixRotationAroundZero, this.camera.frontDir, this.camera.frontDir)
//            geo.multiplicationMatrixVector(this._matrixRotationAroundZero, this.camera.upVector, this.camera.upVector)
//            geo.multiplicationMatrixVector(this._matrixRotationAroundZero, this.camera.position, this.camera.position)
//        }
//
...
//                geo.scale(this.camera.frontDir, this.inertialRadiusOffset, this._deltaPosition)
//                geo.add(this._deltaPosition, this.camera.position, this.camera.position)
//
//                /** inertia is 0, but there is still inertia when wheeling. I think it is the default inertial of device-wheel*/
...
//            return basic.xyzEquality(this.camera.position, this.cachePosition) && basic.xyzEquality(this.camera.upVector, this.cacheUpVector) && basic.xyzEquality(this.camera.frontDir, this.cacheFrontDir)
//        }
//
//
//    }
...
//
//                var whiteObsSphere = BABYLON.Mesh.CreateSphere("sphere", 10, 2 * this.cameraPilot.radiusOfObsShere, scene);
//                var whiteObsSphereMaterial = new BABYLON.StandardMaterial("texture1", scene)
//                whiteObsSphereMaterial.alpha = 0.5
//                whiteObsSphere.material = whiteObsSphereMaterial
//            }
//
//
//        }
